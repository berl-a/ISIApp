...
public class PaymentsActivityApi extends FragmentActivity {
              ...
              //  url="https://mobiletest.payu.in/_payment";
                ...
                PayUCustomBrowserCallback payUCustomBrowserCallback = new PayUCustomBrowserCallback() {
                    ...
                    public void onPaymentSuccess(String payuResponse, String merchantResponse) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), PaymentAcceptActivity.class);
                    ...
                    public void onBackApprove() {
                        PaymentsActivityApi.this.finish();
                    }
...
/*                    @Override
               ...
               /* if (isPaymentByPhonePe == true & isStandAlonePhonePayAvailable == true) {
                    ...
                    new CustomBrowser().addCustomBrowser(PaymentsActivityApi.this, customBrowserConfig, payUCustomBrowserCallback);
                }
